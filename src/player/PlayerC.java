...
public class PlayerC implements Player{
	...
	private Integer lvl_animations_films, lvl_divertissement, lvl_gaming, lvl_humour, lvl_makeup_mode, lvl_musique,
		lvl_sciences, lvl_sport, lvl_cuisine, lvl_montage, lvl_ecriture, lvl_post_prod;
	private long exp_animations_films, exp_divertissement, exp_gaming, exp_humour, exp_makeup_mode, exp_musique, exp_sciences, exp_sport, exp_cuisine,
		exp_montage, exp_ecriture, exp_post_prod;
	
	public PlayerC(String pseudo, String theme, long views, long subscribers, long dollars, double active_subs, Integer work, Integer salaire, 
			Integer lvl_animations_films, long exp_animations_films, Integer lvl_divertissement, long exp_divertissement, 
	...
	public double getActive_subs() {
		return active_subs;
	}

	public void setActive_subs(double active_subs) {
		this.active_subs = active_subs;
	}
